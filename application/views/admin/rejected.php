<div class="Main-Div-rejected">
<?php if(!empty($Arr_rejected)){ $a=1;foreach ($Arr_rejected as $rejected) { ?>
   <input type="hidden" name="rcount" class="rcount" value="<?php echo count($Arr_rejected); ?>">
<div class="Div-rejected new-app-div-interview-box mb-3">
<a href="<?php echo base_url(); ?>admin/candidate_profile/<?php echo $rejected['candidate_applied_id']; ?>">
<li class="delivery-manager-kanban-card-item" id="rejected_<?php echo $rejected['candidate_applied_id']; ?>">
   <img class="kanban-card-item-profile" src="<?php echo base_url(); ?>/assets/candidate_images/<?php echo $rejected['user_photo_path']; ?>"/>
   <div class="delivery-manager-kanban-card-content">
      <div class="delivery-manager-kanban-card-content-title">
         <div class="kanban-card-content-title-info">
          <input type="hidden" name="candidate_applied_id_name" class="candidate_applied_id_name_<?php echo $rejected['candidate_applied_id']; ?>" value="<?php echo $rejected['fname']; ?> <?php echo $rejected['lname']; ?>">
            <h4><?php echo $rejected['fname']; ?> <?php echo $rejected['lname']; ?></h4>
            <p>Experience 
              +<?php 
                  $candidate_applied_id=$rejected['candidate_applied_id'];
      ...
      <div class="delivery-manager-kanban-card-content-info">
         <div class="kanban-card-content-ratings new-app-date">
            <p>+27 <?php echo $rejected['phone_no']; ?></p>
            <ul class="rating-stars">
              <?php if(@$rejected['rating']==''){ ?>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
              <?php }else if(@$rejected['rating']==1){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$rejected['rating']==2){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$rejected['rating']==3){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$rejected['rating']==4){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$rejected['rating']==5){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
        ...
        <span class="new-app-comment-symbol" onclick="Comments_5(<?php echo $rejected['candidate_applied_id']; ?>,<?php echo $company_id; ?>,<?php echo $job_id; ?>,'rejected');"><i class="fa fa-comments" aria-hidden="true"></i></span> 
      </div>
   </div>
</li>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="SaveComments_5();">Save</button>
      </div>
    </div>
  </div>
</div>
...
<script>
function Source_5(type,sel,a,candidate_applied_id)
{
   var val=sel.value;
...
function Comments_5(candidate_applied_id,company_id,job_id,type)
{
  ...
  $.ajax({
        ...
        type: 'POST',
        data: {candidate_applied_id: candidate_applied_id,val: 'rejected',cmnts:''},
        success: function(res) {
