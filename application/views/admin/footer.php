<footer class="footer">
   <div class="container-fluid">
      <div class="row">
         <div class="col-12">
            © <script>document.write(new Date().getFullYear())</script> VIBHO<span class="d-none d-sm-inline-block"> -  Vibho Employee Solutions.</span>
         </div>
      </div>
   </div>
</footer>
...
<script src="<?php echo base_url(); ?>assets/admin/libs/jquery-steps/build/jquery.steps.min.js"></script>
