            ...
            <div class="float-right">
               <div class="dropdown">
                  <?php if($GetRolesAccess['write']==1){?>
                    <a class="btn app-new-employee-button btn-primary dropdown-toggle waves-effect waves-light" href="<?php echo base_url(); ?>admin/add_notifications" ><i class="mdi mdi-plus mr-2"></i>
                    Add Notifications
                    </a>
                <?php } ?>
               </div>
                  ...
                  <table id="datatable" class="table nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                     <thead>
                        <tr>
                           ...
                           <th>Created Date</th>
                           <th>Message</th>
                           <th class="all">View Notification Employees</th>
                        </tr>
                     </thead>
                     <tbody>
                     </tbody>
...
$(document).ready(function() {
   $('#datatable').DataTable({
        ...
        "ajax": {
        "url":  "<?php echo base_url();?>admin/get_notifications_list",
        } 
    });
});
</script>