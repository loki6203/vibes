<div class="Main-Div-client_interview">
   <input type="hidden" name="icount" class="icount" value="<?php echo count($Arr_client_interview); ?>">
<?php if(!empty($Arr_client_interview)){ $a=1;foreach ($Arr_client_interview as $client_interview) { ?>
<div class="Div-client_interview new-app-div-interview-box mb-3">
<a href="<?php echo base_url(); ?>admin/candidate_profile/<?php echo $client_interview['candidate_applied_id']; ?>">
<li class="delivery-manager-kanban-card-item" id="client_interview_<?php echo $client_interview['candidate_applied_id']; ?>">
   <img class="kanban-card-item-profile" src="<?php echo base_url(); ?>/assets/candidate_images/<?php echo $client_interview['user_photo_path']; ?>"/>
   <div class="delivery-manager-kanban-card-content">
      <div class="delivery-manager-kanban-card-content-title">
         <div class="kanban-card-content-title-info">
          <input type="hidden" name="candidate_applied_id_name" class="candidate_applied_id_name_<?php echo $client_interview['candidate_applied_id']; ?>" value="<?php echo $client_interview['fname']; ?> <?php echo $client_interview['lname']; ?>">
            <h4><?php echo $client_interview['fname']; ?> <?php echo $client_interview['lname']; ?></h4>
            <p>Experience 
              +<?php 
                  $candidate_applied_id=$client_interview['candidate_applied_id'];
      ...
      <div class="delivery-manager-kanban-card-content-info">
         <div class="kanban-card-content-ratings new-app-date">
            <p>+91 <?php echo $client_interview['phone_no']; ?></p>
            <ul class="rating-stars">
               <?php if(@$client_interview['rating']==''){ ?>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
              <?php }else if(@$client_interview['rating']==1){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$client_interview['rating']==2){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$client_interview['rating']==3){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$client_interview['rating']==4){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$client_interview['rating']==5){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
         ...
         <div class="kanban-card-content-date new-app-date-2">
            <p><?php echo $client_interview['email_id']; ?></p>
            <span><i class="far fa-clock"></i>
              <?php 
                $candidate_applied_id=$client_interview['candidate_applied_id'];
                $company_id=$client_interview['company_id'];
                $job_id=$client_interview['job_id'];
                if($candidate_applied_id!=''){
                  $StatusDtlogs=$this->db->query("SELECT `candidate_job_status_logs_id`, `emp_id`, `candidate_applied_id`, `company_id`, `job_id`, `status`, `date`, `comments` FROM `candidate_job_status_logs` WHERE `candidate_applied_id`=$candidate_applied_id AND `company_id`=$company_id AND `job_id`=$job_id AND `status`='client_interview' ORDER BY `candidate_job_status_logs_id` DESC")->row_array();
         ...
         <select class="form-control" name="select_contacted" id="select_contacted" onchange="Source_8(8,this,<?php echo $a; ?>,<?php echo $client_interview['candidate_applied_id']; ?>);">
           ...
           <option value="client interview" selected>client interview</option>
           <option value="hired">hired</option>
           <option value="rejected">rejected</option>
        </select>
        <span class="new-app-comment-symbol" onclick="Comments_8(<?php echo $client_interview['candidate_applied_id']; ?>,<?php echo $company_id; ?>,<?php echo $job_id; ?>,'client_interview');"><i class="fa fa-comments" aria-hidden="true"></i></span> 
      </div>
   </div>
</li>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="SaveComments_8();">Save</button>
      </div>
    </div>
  </div>
</div>
...
<script>
function Source_8(type,sel,a,candidate_applied_id)
{
   var val=sel.value;
...
function Comments_8(candidate_applied_id,company_id,job_id,type)
{
  ...
  $.ajax({
        ...
        type: 'POST',
        data: {candidate_applied_id: candidate_applied_id,val: 'client_interview',cmnts:''},
        success: function(res) {
