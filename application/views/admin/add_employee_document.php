      ...
      <div class="row align-items-center">
         <div class="col-sm-6">
            <div class="page-title-box">
               <h4 class="font-size-18">Add Employee Checks</h4>
               <ol class="breadcrumb mb-0">
                  <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/dashboard">Dashboard</a></li>
                  <li class="breadcrumb-item active">Add Employee Checks</li>
               </ol>
            </div>
         </div>
         <div class="col-sm-6">
            <div class="float-right">
               <div class="dropdown">
                  <a class="btn app-new-employee-button btn-primary dropdown-toggle waves-effect waves-light" href="<?php echo base_url(); ?>admin/employee_documents/" >
...
var i=2;
 $(".itc_add_more").click(function(){ 
      ...
      var html = $(".apped_add_more").append('<div class="form-group row itc-add-more-div"><label for="example-time-input" class="col-sm-2 col-form-label"> ITC Documents</label><div class="col-sm-4"><input type="file" name="itcimage[]" class="form-control filestyle" accept="image/png, image/jpg, image/jpeg, application/pdf"/></div><div class="col-sm-4"><button type="button" class="remove_add_more btn btn-danger waves-effect waves-light mr-1">Remove</button></div></div></div></div></div>&nbsp;&nbsp;');
      i++;
 });
 ...
 $(".criminal_add_more").click(function(){ 
      var html = $(".apped_criminal_add_more").append('<div class="form-group row criminal-add-more-div"><label for="example-time-input" class="col-sm-2 col-form-label"> Criminal Documents</label><div class="col-sm-4"><input type="file" name="criminalimage[]" class="form-control filestyle" accept="image/png, image/jpg, image/jpeg, application/pdf"/></div><div class="col-sm-4"><button type="button" class="remove_criminal_add_more btn btn-danger waves-effect waves-light mr-1">Remove</button></div></div></div></div></div>&nbsp;&nbsp;');
 });
...
$(".educational_add_more").click(function(){ 
      var html = $(".apped_educational_add_more").append('<div class="form-group row edu-add-more-div"><label for="example-time-input" class="col-sm-2 col-form-label"> Educational Documents</label><div class="col-sm-4"><input type="file" name="educationalimage[]" class="form-control filestyle" accept="image/png, image/jpg, image/jpeg, application/pdf"/></div><div class="col-sm-4"><button type="button" class="remove_edu_add_more btn btn-danger waves-effect waves-light mr-1">Remove</button></div></div></div></div></div>&nbsp;&nbsp;');
 });
...
$(".ref_add_more").click(function(){ 
      var html = $(".apped_ref_add_more").append('<div class="form-group row ref-add-more-div"><label for="example-time-input" class="col-sm-2 col-form-label"> Reference Documents</label><div class="col-sm-4"><input type="file" name="referenceimage[]" class="form-control filestyle" accept="image/png, image/jpg, image/jpeg, application/pdf"/></div><div class="col-sm-4"><button type="button" class="remove_ref_add_more btn btn-danger waves-effect waves-light mr-1">Remove</button></div></div></div></div></div>&nbsp;&nbsp;');
 });
