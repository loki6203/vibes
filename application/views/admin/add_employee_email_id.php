   ...
   <div class="container-fluid">
         ...
         <div class="col-sm-6">
            <div class="page-title-box">
               ...
               <ol class="breadcrumb mb-0">
                  ...
                  <li class="breadcrumb-item active">Add Employee Email Id's</li>
               </ol>
            </div>
         </div>
         <div class="col-sm-6">
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="card">
               <div class="card-body">
                  <form method="post" action="<?php echo base_url(); ?>admin/save_employee_email_id" id="save_employee_email_id" name="save_employee_email_id" enctype="multipart/form-data" class="custom-validation">
