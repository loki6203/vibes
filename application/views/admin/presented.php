<div class="Main-Div-presented">
   <input type="hidden" name="icount" class="icount" value="<?php echo count($Arr_presented); ?>">
<?php if(!empty($Arr_presented)){ $a=1;foreach ($Arr_presented as $presented) { ?>
<div class="Div-presented new-app-div-interview-box mb-3">
<a href="<?php echo base_url(); ?>admin/candidate_profile/<?php echo $presented['candidate_applied_id']; ?>">
<li class="delivery-manager-kanban-card-item" id="presented_<?php echo $presented['candidate_applied_id']; ?>">
   <img class="kanban-card-item-profile" src="<?php echo base_url(); ?>/assets/candidate_images/<?php echo $presented['user_photo_path']; ?>"/>
   <div class="delivery-manager-kanban-card-content">
      <div class="delivery-manager-kanban-card-content-title">
         <div class="kanban-card-content-title-info">
          <input type="hidden" name="candidate_applied_id_name" class="candidate_applied_id_name_<?php echo $presented['candidate_applied_id']; ?>" value="<?php echo $presented['fname']; ?> <?php echo $presented['lname']; ?>">
            <h4><?php echo $presented['fname']; ?> <?php echo $presented['lname']; ?></h4>
            <p>Experience 
              +<?php 
                  $candidate_applied_id=$presented['candidate_applied_id'];
      ...
      <div class="delivery-manager-kanban-card-content-info">
         <div class="kanban-card-content-ratings new-app-date">
            <p><i class="fa fa-phone" aria-hidden="true"></i> +27 <?php echo $presented['phone_no']; ?></p>
            <ul class="rating-stars">
               <?php if(@$presented['rating']==''){ ?>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
              <?php }else if(@$presented['rating']==1){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$presented['rating']==2){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$presented['rating']==3){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$presented['rating']==4){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$presented['rating']==5){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
         ...
         <select class="form-control" name="select_contacted" id="select_contacted" onchange="Source_6(6,this,<?php echo $a; ?>,<?php echo $presented['candidate_applied_id']; ?>);">
           <option value="source_applied">source/applied</option>
           <option value="contacted">contacted</option>
           <option value="internal interview">internal interview</option>
           <option value="presented" selected>presented</option>
           <option value="shortlisted">shortlisted</option>
           <option value="client interview">client interview</option>
           <option value="hired">hired</option>
           <option value="rejected">rejected</option>
        </select>
        <span class="new-app-comment-symbol" onclick="Comments_6(<?php echo $presented['candidate_applied_id']; ?>,<?php echo $company_id; ?>,<?php echo $job_id; ?>,'presented');"><i class="fa fa-comments" aria-hidden="true"></i></span> 
      </div>
   </div>
</li>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="SaveComments_6();">Save</button>
      </div>
    </div>
  </div>
</div>
...
<script>
function Source_6(type,sel,a,candidate_applied_id)
{
   var val=sel.value;
...
function Comments_6(candidate_applied_id,company_id,job_id,type)
{
  ...
  $.ajax({
        ...
        type: 'POST',
        data: {candidate_applied_id: candidate_applied_id,val: 'presented',cmnts:''},
        success: function(res) {
