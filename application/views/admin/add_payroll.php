   ...
   <div class="container-fluid">
      ...
      <div class="row align-items-center">
         <div class="col-sm-6">
            <div class="page-title-box">
               <h4 class="font-size-18">Add Payroll</h4>
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="card">
               <div class="card-body">
                  <form method="post" action="<?php echo base_url(); ?>admin/save_payroll" id="save_payroll" name="save_payroll" enctype="multipart/form-data" class="custom-validation">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <input type="text" name="current_salary" id="current_salary" class="form-control"  placeholder="Select Current Salary" required/>
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="example-time-input" class="col-sm-2 col-form-label"> Allowance</label>
                        <div class="col-sm-10">
                           <input type="text" name="allowence" id="allowence" class="form-control"  placeholder="Enter Allowance" required/>
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="example-time-input" class="col-sm-2 col-form-label"> Claim Amount</label>
                        <div class="col-sm-10">
                           <input type="text" name="claim_amt" id="claim_amt" class="form-control"  placeholder="Enter Claim Amount" required/>
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="example-time-input" class="col-sm-2 col-form-label"> Rent</label>
                        <div class="col-sm-10">
                           <input type="text" name="rent" id="rent" class="form-control keupinput" placeholder="Enter Rent" required/>
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="example-time-input" class="col-sm-2 col-form-label"> Vibho HR</label>
                        <div class="col-sm-10">
                           <input type="text" name="vibho_hr" id="vibho_hr" class="form-control" placeholder="Enter Vibho HR" required/>
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="example-time-input" class="col-sm-2 col-form-label"> Vibho Manager</label>
                        <div class="col-sm-10">
                           <input type="text" name="vibho_manager" id="vibho_manager" class="form-control" placeholder="Enter Vibho Manager" required/>
                        </div>
                     </div>
                      <div class="form-group row">
                        <label for="example-time-input" class="col-sm-2 col-form-label"> Client Manager</label>
                        <div class="col-sm-10">
                           <input type="text" name="client_manager" id="client_manager" class="form-control" placeholder="Enter Client Manager" required/>
                        </div>
                     </div>
