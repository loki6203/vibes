   ...
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-sm-12">
            <div class="card">
               <div class="card-body">
                  <form method="post" action="<?php echo base_url(); ?>admin/update_employee" id="form-horizontal" name="update_employee" enctype="multipart/form-data" class="form-horizontal form-wizard-wrapper form-wizard-wrapper-custom custom-validation">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group row">
                                 ...
                                 <div class="col-lg-12">
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="client_billable" name="client_billable" value="Yes" <?php if($employee['client_billable']=='Yes'){echo "checked"; } ?>/>
                                    <label class="custom-control-label" for="client_billable">Yes</label>
                                    </div>
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="client_billable2" name="client_billable" value="No" <?php if($employee['client_billable']=='No'){echo "checked"; } ?>/>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group row">
                                 ...
                                 <div class="col-lg-12">
                                    <input type="text" name="ifsc_code" id="ifsc_code" class="form-control" placeholder="Enter Branch Code" value="<?php echo $employee['ifsc_code']; ?>"/>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                                 ...
                                 <div class="col-lg-12">
                                       ...
                                       <div>
                                          ...
                                          if($GetType=='pdf' || $GetType=='PDF'){ ?>
                                                <a href="<?php echo base_url(); ?>assets/emp_identification_image/<?php echo $employee['identification_image_path']; ?>" target="_blank"><img src="<?php echo base_url(); ?>assets/pdf_imgpng.jpg" id="output" width="100px" height="100px"></a>
                                          <?php } else { ?>
                                             <a href="<?php echo base_url(); ?>assets/emp_identification_image/<?php echo $employee['identification_image_path']; ?>" target="_blank"><img src="<?php echo base_url(); ?>assets/emp_identification_image/<?php echo $employee['identification_image_path']; ?>" id="output" width="100px" height="100px"></a>
                                       <?php } ?>
                                       </div>
                                 </div>
                              </div>
                     ...
                     <!--               <div class="col-lg-12">-->
                     <!--                  <input type="text" name="BASCI" id="BASCI" class="form-control cls-readonly" placeholder="BASCI" value="<?php echo @$Compensation['BASCI']; ?>" />-->
                     <!--               </div>-->
                     <!--            </div>-->
                     <!--         </div>-->
                     <!--         <div class="col-md-6">-->
                     ...
                     <!--               <div class="col-lg-12">-->
                     <!--                  <input type="text" name="HRA" id="HRA" class="form-control cls-readonly" placeholder="HRA" value="<?php echo @$Compensation['HRA']; ?>"/>-->
                     <!--               </div>-->
                     <!--            </div>-->
                     <!--         </div>-->
                     <!--      </div>-->
                     ...
                     <!--               <div class="col-lg-12">-->
                     <!--                  <input type="text" name="CONVEYANCE" id="CONVEYANCE" class="form-control cls-readonly" placeholder="CONVEYANCE" value="<?php echo @$Compensation['CONVEYANCE']; ?>"/>-->
                     <!--               </div>-->
                     <!--            </div>-->
                     <!--         </div>-->
                     <!--         <div class="col-md-6">-->
                     ...
                     <!--               <div class="col-lg-12">-->
                     <!--                  <input type="text" name="MEDICAL_ALLOWANCE" id="MEDICAL_ALLOWANCE" class="form-control cls-readonly" placeholder="MEDICAL ALLOWANCE" value="<?php echo @$Compensation['MEDICAL_ALLOWANCE']; ?>"/>-->
                     <!--               </div>-->
                     <!--            </div>-->
                     <!--         </div>-->
                     <!--         <div class="col-md-6">-->
                     ...
                     <!--               <div class="col-lg-12">-->
                     <!--                  <input type="text" name="OTHER_BENEFITS" id="OTHER_BENEFITS" class="form-control cls-readonly" placeholder="OTHER BENEFITS" value="<?php echo @$Compensation['OTHER_BENEFITS']; ?>"/>-->
                     <!--               </div>-->
                     <!--            </div>-->
                     <!--         </div>-->
                     <!--         <div class="col-md-6">-->
                     ...
                     <!--               <div class="col-lg-12">-->
                     <!--                  <input type="text" name="VARIABLES" id="VARIABLES" class="form-control cls-readonly" placeholder="VARIABLES" value="<?php echo @$Compensation['VARIABLES']; ?>"/>-->
                     <!--               </div>-->
                     <!--            </div>-->
                     <!--         </div>-->
                     <!--      </div>-->
                     ...
                     <!--                  <div class="col-lg-12">-->
                     <!--                     <input type="text" name="PT" id="PT" class="form-control cls-readonly" placeholder="PT" value="<?php echo @$Compensation['PT']; ?>"/>-->
                     <!--                  </div>-->
                     <!--               </div>-->
                     <!--            </div>-->
                     <!--            <div class="col-md-6">-->
                     ...
                     <!--                  <div class="col-lg-12">-->
                     <!--                     <input type="text" name="PF" id="PF" class="form-control cls-readonly" placeholder="PF" value="<?php echo @$Compensation['PF']; ?>"/>-->
                     <!--                  </div>-->
                     <!--               </div>-->
                     <!--            </div>-->
                     <!--         </div>-->
                     ...
                     <!--               <div class="col-lg-12">-->
                     <!--                  <input type="text" name="TDS" id="TDS" class="form-control cls-readonly" placeholder="TDS" value="<?php echo @$Compensation['TDS']; ?>"/>-->
                     <!--               </div>-->
                     <!--            </div>-->
                     <!--         </div>-->
                     <!--         <div class="col-md-6">-->
                     ...
                     <!--               <div class="col-lg-12">-->
                     <!--                  <input type="text" name="OTHERS" id="OTHERS" class="form-control cls-readonly" placeholder="OTHERS" value="<?php echo @$Compensation['OTHERS']; ?>"/>-->
                     <!--               </div>-->
                     <!--            </div>-->
                     <!--         </div>-->
                     <!--      </div>-->
                     ...
                     <!--               <div class="col-lg-12">-->
                     <!--                  <input type="text" name="GROSS_TOTAL" id="GROSS TOTAL" class="form-control cls-readonly" placeholder="GROSS TOTAL" value="<?php echo @$Compensation['GROSS_TOTAL']; ?>"/>-->
                     <!--               </div>-->
                     <!--            </div>-->
                     <!--         </div>-->
                     <!--         <div class="col-md-6">-->
                     ...
                     <!--               <div class="col-lg-12">-->
                     <!--                  <input type="text" name="DEDUCTIONS" id="DEDUCTIONS" class="form-control cls-readonly" placeholder="DEDUCTIONS" value="<?php echo @$Compensation['DEDUCTIONS']; ?>"/>-->
                     <!--               </div>-->
                     <!--            </div>-->
                     <!--         </div>-->
                     <!--         <div class="col-md-6">-->
                     ...
                     <!--               <div class="col-lg-12">-->
                     <!--                  <input type="text" name="NET_PAY" id="NET_PAY" class="form-control cls-readonly" placeholder="NET PAY" value="<?php echo @$Compensation['NET_PAY']; ?>"/>-->
                     <!--               </div>-->
                     <!--            </div>-->
                     <!--         </div>-->
                     <!--         <div class="col-md-6">-->
