      ...
      <div class="row align-items-center">
         <div class="col-sm-6">
            <div class="page-title-box">
               <h4 class="font-size-18"> Employee Management</h4>
         ...
         <div class="col-sm-6">
            <div class="float-right">
               <div class="dropdown">
                   <a class="btn app-new-employee-button btn-danger waves-effect waves-light" href="<?php echo base_url(); ?>admin/inactive_employee" >
                  Inactive Employees
                  </a>
                  <?php if($GetRolesAccess['write']==1){?>
                    <a class="btn app-new-employee-button btn-primary dropdown-toggle waves-effect waves-light" href="<?php echo base_url(); ?>admin/add_employee" ><i class="mdi mdi-plus mr-2"></i>
                    Add Employee
                    </a>
                <?php } ?>
                <a class="btn app-new-employee-button btn-excel dropdown-toggle waves-effect waves-light" href="<?php echo base_url(); ?>admin/export_employees/" ><i class="fa fa-download" aria-hidden="true"></i>&nbsp; 
                  Excel
                  </a>
               </div>
            </div>
