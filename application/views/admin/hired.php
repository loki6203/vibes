<div class="Main-Div-hired">
<?php if(!empty($Arr_hired)){ $a=1;foreach ($Arr_hired as $hired) { ?>
   <input type="hidden" name="hcount" class="hcount" value="<?php echo count($Arr_hired); ?>">
<div class="Div-hired new-app-div-interview-box mb-3">
<a href="<?php echo base_url(); ?>admin/candidate_profile/<?php echo $hired['candidate_applied_id']; ?>">
<li class="delivery-manager-kanban-card-item" id="hired_<?php echo $hired['candidate_applied_id']; ?>">
  <img class="kanban-card-item-profile" src="<?php echo base_url(); ?>/assets/candidate_images/<?php echo $hired['user_photo_path']; ?>"/>
   <div class="delivery-manager-kanban-card-content">
      <div class="delivery-manager-kanban-card-content-title">
         <div class="kanban-card-content-title-info">
          <input type="hidden" name="candidate_applied_id_name" class="candidate_applied_id_name_<?php echo $hired['candidate_applied_id']; ?>" value="<?php echo $hired['fname']; ?> <?php echo $hired['lname']; ?>">
            <h4><?php echo $hired['fname']; ?> <?php echo $hired['lname']; ?></h4>
            <p>Experience 
              +<?php 
                  $candidate_applied_id=$hired['candidate_applied_id'];
      ...
      <div class="delivery-manager-kanban-card-content-info">
         <div class="kanban-card-content-ratings new-app-date">
            <p>+27 <?php echo $hired['phone_no']; ?></p>
            <ul class="rating-stars">
               ...
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
              <?php }else if(@$hired['rating']==1){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$hired['rating']==2){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$hired['rating']==3){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$hired['rating']==4){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$hired['rating']==5){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
         ...
         <div class="kanban-card-content-date new-app-date-2">
            <p><?php echo $hired['email_id']; ?></p>
            <span><i class="far fa-clock"></i>
              <?php 
                $candidate_applied_id=$hired['candidate_applied_id'];
                $company_id=$hired['company_id'];
                $job_id=$hired['job_id'];
                $StatusDtlogs=$this->db->query("SELECT `candidate_job_status_logs_id`, `emp_id`, `candidate_applied_id`, `company_id`, `job_id`, `status`, `date`, `comments` FROM `candidate_job_status_logs` WHERE `candidate_applied_id`=$candidate_applied_id AND `company_id`=$company_id AND `job_id`=$job_id AND `status`='hired' ORDER BY `candidate_job_status_logs_id` DESC")->row_array();
                echo DD_M_YY_h_i_s($StatusDtlogs['date']); 
              ?>
            </span>
         </div>
      </a>
         <select class="form-control" name="select_contacted" id="select_contacted" onchange="Source_4(4,this,<?php echo $a; ?>,<?php echo $hired['candidate_applied_id']; ?>);">
        ...
        <span class="new-app-comment-symbol" onclick="Comments_4(<?php echo $hired['candidate_applied_id']; ?>,<?php echo $company_id; ?>,<?php echo $job_id; ?>,'hired');"><i class="fa fa-comments" aria-hidden="true"></i></span> 
      </div>
   </div>
</li>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="SaveComments_4();">Save</button>
      </div>
    </div>
  </div>
</div>
...
<script>
function Source_4(type,sel,a,candidate_applied_id)
{
   var val=sel.value;
...
function Comments_4(candidate_applied_id,company_id,job_id,type)
{
  ...
  $.ajax({
        ...
        type: 'POST',
        data: {candidate_applied_id: candidate_applied_id,val: 'hired',cmnts:''},
        success: function(res) {
