<div class="Main-Div-source_applied">
<input type="hidden" name="scount" class="scount" value="<?php echo count($Arr_source); ?>">
<?php if(!empty($Arr_source)){ $a=1;foreach ($Arr_source as $source) { ?>
<div class="Div-source_applied new-app-div-interview-box mb-3">
<a href="<?php echo base_url(); ?>admin/candidate_profile/<?php echo $source['candidate_applied_id']; ?>">
<li class="delivery-manager-kanban-card-item" id="source_applied_<?php echo $source['candidate_applied_id']; ?>">
   <img class="kanban-card-item-profile" src="<?php echo base_url(); ?>/assets/candidate_images/<?php echo $source['user_photo_path']; ?>"/>
   <div class="delivery-manager-kanban-card-content">
      <div class="delivery-manager-kanban-card-content-title">
         <div class="kanban-card-content-title-info">
            <input type="hidden" name="candidate_applied_id_name" class="candidate_applied_id_name_<?php echo $source['candidate_applied_id']; ?>" value="<?php echo $source['fname']; ?> <?php echo $source['lname']; ?>">
            <h4><?php echo $source['fname']; ?> <?php echo $source['lname']; ?></h4>
            <p>Experience 
              +<?php 
                  $candidate_applied_id=$source['candidate_applied_id'];
      ...
      <div class="delivery-manager-kanban-card-content-info">
         <div class="kanban-card-content-ratings new-app-date">
            <p>+27 <?php echo $source['phone_no']; ?></p>
            <ul class="rating-stars">
               <?php if(@$source['rating']==''){ ?>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
              <?php }else if(@$source['rating']==1){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$source['rating']==2){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$source['rating']==3){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$source['rating']==4){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$source['rating']==5){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
         ...
         <div class="kanban-card-content-date new-app-date-2">
            <p><?php echo $source['email_id']; ?></p>
            <span><i class="far fa-clock"></i> <?php echo DD_M_YY_h_i_s(@$source['created_at']); ?></span>
         </div>  
         </a>              
        <select class="form-control" name="source_applied" id="source_applied" onchange="Source_1(1,this,<?php echo $a; ?>,<?php echo $source['candidate_applied_id']; ?>);">
        ...
        <span class="new-app-comment-symbol" onclick="Comments_1(<?php echo $source['candidate_applied_id']; ?>,<?php echo $company_id; ?>,<?php echo $job_id; ?>,'source_applied');"><i class="fa fa-comments" aria-hidden="true"></i></span>                      
      </div>
   </div>
</li>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="SaveComments_1();">Save</button>
      </div>
    </div>
  </div>
</div>
...
<script>
   function Source_1(type,sel,a,candidate_applied_id)
   {
      var val=sel.value;
...
function Comments_1(candidate_applied_id,company_id,job_id,type)
{
  ...
  $.ajax({
        ...
        type: 'POST',
        data: {candidate_applied_id: candidate_applied_id,val: 'source_applied',cmnts:''},
        success: function(res) {
