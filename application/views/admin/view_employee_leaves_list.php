      ...
      <div class="row align-items-center">
         <div class="col-sm-6">
            <div class="page-title-box">
               <h4 class="font-size-18"> Employee Applied Leave's List</h4>
               <ol class="breadcrumb mb-0">
                  <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/dashboard">Dashboard</a></li>
                  <li class="breadcrumb-item active"> Employee Applied Leave's List</li>
               </ol>
            </div>
         </div>
         <div class="col-sm-6">
                        ...
                        <tr class="row_<?php echo $a; ?>">
                           ...
                           <td><?php echo $res['leave_type']; ?></td>
                             <?php if($res['leave_status']=='0'){ ?>
                                <td><span style="color: #38a4f8">Pending</span><br>Date: <?php echo date("d-M-Y H:i:sa", strtotime($res['created_at'])); ?><br><a href="<?php echo base_url(); ?>assets/leave_doctor_certificate/<?php echo $res['document_file_name'];?>" target="_blank">View</a></td>
                              ...
                              ?>
                                ...
                                (<?php 
                                    ...
                                    ?>)
                                </span><br>Date: <?php echo date("d-M-Y H:i:sa", strtotime($res['approved_date'])); ?><br><a href="<?php echo base_url(); ?>assets/leave_doctor_certificate/<?php echo $res['document_file_name'];?>" target="_blank">View</a></td>
                             <?php } else if($res['leave_status']=='2'){ 
                              ...
                              ?>
                                ...
                                </span><br>Date: <?php echo date("d-M-Y H:i:sa", strtotime($res['rejected_by_admin_date'])); ?><br>Rejected Reason: <?php echo $res['leave_rejected_reason']; ?><br><a href="<?php echo base_url(); ?>assets/leave_doctor_certificate/<?php echo $res['document_file_name'];?>" target="_blank">View</a></td>
                              ...
                              ?>
                                <td><span style="color: #ff0000;">Cancelled by User </span><br>Date: <?php echo date("d-M-Y H:i:sa", strtotime($res['cancelled_by_user_date'])); ?><br><a href="<?php echo base_url(); ?>assets/leave_doctor_certificate/<?php echo $res['document_file_name'];?>" target="_blank">View</a></td>
                             <?php } else { } ?>
                             <?php if($res['leave_status']=='0'){ ?>
