...
<div class="Div-interview new-app-div-interview-box mb-3">
<a href="<?php echo base_url(); ?>admin/candidate_profile/<?php echo $interview['candidate_applied_id']; ?>">
<li class="delivery-manager-kanban-card-item" id="internal_interview_<?php echo $interview['candidate_applied_id']; ?>">
   ...
   <div class="delivery-manager-kanban-card-content">
      <div class="delivery-manager-kanban-card-content-title">
         <div class="kanban-card-content-title-info">
          <input type="hidden" name="candidate_applied_id_name" class="candidate_applied_id_name_<?php echo $interview['candidate_applied_id']; ?>" value="<?php echo $interview['fname']; ?> <?php echo $interview['lname']; ?>">
      ...
      <div class="delivery-manager-kanban-card-content-info">
         <div class="kanban-card-content-ratings  new-app-date">
            <p><i class="fa fa-phone" aria-hidden="true"></i> +27 <?php echo $interview['phone_no']; ?></p>
         ...
         <select class="form-control" name="select_contacted" id="select_contacted" onchange="Source_3(3,this,<?php echo $a; ?>,<?php echo $interview['candidate_applied_id']; ?>);">
           ...
           <option value="internal interview" selected>internal interview</option>
        ...
        <span class="new-app-comment-symbol" onclick="Comments_3(<?php echo $interview['candidate_applied_id']; ?>,<?php echo $company_id; ?>,<?php echo $job_id; ?>,'internal_interview');"><i class="fa fa-comments" aria-hidden="true"></i></span> 
      </div>
   </div>
</li>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="SaveComments_3();">Save</button>
      </div>
    </div>
  </div>
</div>
...
function Comments_3(candidate_applied_id,company_id,job_id,type)
{
  ...
  $.ajax({
        ...
        type: 'POST',
        data: {candidate_applied_id: candidate_applied_id,val: 'internal_interview',cmnts:''},
        success: function(res) {
