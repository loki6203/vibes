<div class="Main-Div-shortlisted">
   <input type="hidden" name="icount" class="icount" value="<?php echo count($Arr_shortlisted); ?>">
<?php if(!empty($Arr_shortlisted)){ $a=1;foreach ($Arr_shortlisted as $shortlisted) { ?>
<div class="Div-shortlisted new-app-div-interview-box mb-3">
<a href="<?php echo base_url(); ?>admin/candidate_profile/<?php echo $shortlisted['candidate_applied_id']; ?>">
<li class="delivery-manager-kanban-card-item" id="shortlisted_<?php echo $shortlisted['candidate_applied_id']; ?>">
   <img class="kanban-card-item-profile" src="<?php echo base_url(); ?>/assets/candidate_images/<?php echo $shortlisted['user_photo_path']; ?>"/>
   <div class="delivery-manager-kanban-card-content">
      <div class="delivery-manager-kanban-card-content-title">
         <div class="kanban-card-content-title-info">
          <input type="hidden" name="candidate_applied_id_name" class="candidate_applied_id_name_<?php echo $shortlisted['candidate_applied_id']; ?>" value="<?php echo $shortlisted['fname']; ?> <?php echo $shortlisted['lname']; ?>">
            <h4><?php echo $shortlisted['fname']; ?> <?php echo $shortlisted['lname']; ?></h4>
            <p>Experience 
              +<?php 
                  $candidate_applied_id=$shortlisted['candidate_applied_id'];
      ...
      <div class="delivery-manager-kanban-card-content-info">
         <div class="kanban-card-content-ratings new-app-date">
            <p>+91 <?php echo $shortlisted['phone_no']; ?></p>
            <ul class="rating-stars">
               <?php if(@$shortlisted['rating']==''){ ?>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
              <?php }else if(@$shortlisted['rating']==1){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$shortlisted['rating']==2){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$shortlisted['rating']==3){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$shortlisted['rating']==4){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="far fa-star"></i></li>
             <?php }else if(@$shortlisted['rating']==5){ ?>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
               <li><i class="fas fa-star"></i></li>
         ...
         <select class="form-control" name="select_contacted" id="select_contacted" onchange="Source_7(7,this,<?php echo $a; ?>,<?php echo $shortlisted['candidate_applied_id']; ?>);">
        ...
        <span class="new-app-comment-symbol" onclick="Comments_7(<?php echo $shortlisted['candidate_applied_id']; ?>,<?php echo $company_id; ?>,<?php echo $job_id; ?>,'shortlisted');"><i class="fa fa-comments" aria-hidden="true"></i></span> 
      </div>
   </div>
</li>
</div>
...
<script>
function Source_7(type,sel,a,candidate_applied_id)
{
   var val=sel.value;
...
function Comments_7(candidate_applied_id,company_id,job_id,type)
{
  ...
  $.ajax({
        ...
        type: 'POST',
        data: {candidate_applied_id: candidate_applied_id,val: 'shortlisted',cmnts:''},
        success: function(res) {
