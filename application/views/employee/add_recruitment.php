   ...
   <div class="container-fluid">
      ...
      <div class="row align-items-center">
         <div class="col-sm-6">
            <div class="page-title-box">
               <h4 class="font-size-18">Add Recruitment</h4>
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="card">
               <div class="card-body">
                  <form method="post" action="<?php echo base_url(); ?>employee/save_recruitment" id="save_recruitment" name="save_recruitment" enctype="multipart/form-data" class="custom-validation">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <input type="text" name="job_role" id="job_role" class="form-control" placeholder="Enter Job Role" required />
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="example-time-input" class="col-sm-2 col-form-label"> Client</label>
                        <div class="col-sm-10">
                           <input type="text" name="client" id="client" class="form-control" placeholder="Enter Client" required />
                        </div>
                     </div>
                     <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <input type="text" name="applied_role_position" id="applied_role_position" class="form-control" placeholder="Enter Applied Role/position" required />
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="example-time-input" class="col-sm-2 col-form-label"> Client Feedback</label>
                        <div class="col-sm-10">
                           <input type="text" name="client_feedback" id="client_feedback" class="form-control" placeholder="Enter Client Feedback" required />
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="example-time-input" class="col-sm-2 col-form-label"> Proposed Rate card to client</label>
                        <div class="col-sm-10">
                           <input type="text" name="proposed_rate_card_to_client" id="proposed_rate_card_to_client" class="form-control" placeholder="Enter Proposed Rate card to client" required />
                        </div>
                     </div>
                     <div class="form-group row">
                     ...
                     <div class="form-group row">
                        <label for="example-time-input" class="col-sm-2 col-form-label"> NoComments </label>
                        <div class="col-sm-10">
                           <input type="text" name="comments" id="comments" class="form-control" placeholder="Enter Comments" required />
                        </div>
                     </div>
