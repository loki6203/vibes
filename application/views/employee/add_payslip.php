               ...
               <div class="card-body">
                  <form method="post" action="<?php echo base_url(); ?>admin/save_payslip" id="save_payslip" name="save_payslip" enctype="multipart/form-data" class="custom-validation">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <input type="text" name="month" id="month" class="form-control" placeholder="Select Select Month" required/>
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="example-time-input emialid" class="col-sm-2 col-form-label">Select Year</label>
                        <div class="col-sm-10">
                           <input type="text" name="year" id="year" class="form-control" placeholder="Select Select Year" required/>
                        </div>
                     </div>
                     <div class="form-group row">
