      ...
      <div class="row align-items-center">
         <div class="col-sm-6 ">
            <div class="page-title-box">
               <h4 class="font-size-18"> Timesheet Report</h4>
...
function FormSubmit() {
    ...
    $.ajax({
        url: '<?php echo site_url('employee/get_timesheet_report_list'); ?>',
        type: 'POST',
    ...
    $.ajax({
        ...
        success: function(response){
          ...
          $.each(response,function(index,data){
             $('#emp_id').append('<option value="'+data['emp_id']+'">'+data['fname']+'</option>');
          });
        }
     });
  }
