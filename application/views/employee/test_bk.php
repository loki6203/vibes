...
// $rig =mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM register where id ='".$username."'"));

$des =  'desgination';

// $designation  = mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM designation where id ='".$des."'"));
...
// $selc = mysqli_query($conn,"SELECT distinct client,item FROM `timesheet_management` where `user_id` = $username and (`workeddate`>='$startval' && `workeddate`<='$endval') ORDER BY `workeddate`");
$selc = array(11,12,13,14,15,16);

// $count_selc = mysqli_query($conn,"SELECT distinct client,item FROM `timesheet_management`   where `user_id` = $username ORDER BY `workeddate`");
...
<td class ="firstdivtable"><?php echo 6;?></div>
</td>
...
{
?>
<td  style="vertical-align: baseline;" rowspan="<?php echo 7; ?>"><?php echo 7765756;?></td>  
<?php } else { ?>
...
// $rig =mysqli_query($conn,"SELECT * FROM register where id ='".$username."'");

// $row = mysqli_fetch_array($rig);


// $timesheets = mysqli_query($conn," select * from register where id='".$username."'");
// $timesheetfetchs = mysqli_fetch_array($timesheets);
