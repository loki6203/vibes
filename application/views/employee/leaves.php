      ...
      <div class="row align-items-center">
         ...
         <div class="col-sm-6">
            <div class="float-right">
               <div class="dropdown">
                  <a class="btn app-new-employee-button btn-primary dropdown-toggle waves-effect waves-light" href="<?php echo base_url(); ?>employee/add_leaves" ><i class="mdi mdi-plus mr-2"></i>
                  Add Leaves
                  </a>
               </div>
            </div>
...
$(document).ready(function() {
   $('#datatable').DataTable({
        ...
        "ajax": {
        "url":  "<?php echo base_url();?>employee/get_leaves_list",
        } 
    });

  $('#termination_date').Zebra_DatePicker({format: 'd-m-Y'});
  $('#termination_date').Zebra_DatePicker({format: 'd-m-Y'});
});
