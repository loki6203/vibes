   ...
   <div class="container-fluid">
      ...
      <div class="row align-items-center">
         ...
         <div class="col-sm-6">
            <div class="float-right d-none d-md-block">
               <div class="dropdown">
                  <a class="btn btn-primary dropdown-toggle waves-effect waves-light" href="<?php echo base_url(); ?>employee/dashboard/" >
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="card">
               <div class="card-body">
                  <form method="post" action="<?php echo base_url(); ?>employee/update_password" id="change_password" name="change_password" enctype="multipart/form-data" class="custom-validation">
                     ...
                     <div class="form-group mb-0 float-right">
                        <div>
                           <a class="btn btn-danger waves-effect waves-light" href="<?php echo base_url(); ?>employee/dashboard/">Cancel</a>
