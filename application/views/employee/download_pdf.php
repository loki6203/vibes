                                    ...
                                    <td align="right">
                                        <table>
                                            <tr>
                                                ...
                                                <td class="font-medium">: <?php echo @ucfirst($get_employee_client_desig_name['fname']);?> <?php echo @ucfirst($get_employee_client_desig_name['lname']);?></td>
                                            </tr>
                                            <tr>
                                       ...
                                       <tr>
                                          ...
                                          <td class="w-35">
                                              <table class="table-signature-info">
                                                  <tr>
                                                      <td>Employee Name</td>
                                                      <td class="font-bold">: <?php echo @ucfirst($get_employee_client_desig_name['fname']);?> <?php echo @ucfirst($get_employee_client_desig_name['lname']);?> </td>
                                                  </tr>
                                              </table>
                                          </td>
                                       </tr>
